 ...
 * Created:     May 2010
 *
 * Description: This header file defines the HDMI TX driver internal interface.
 *
 *****************************************************************************/

#ifndef __HDMI_INTERNAL_H__
#define __HDMI_INTERNAL_H__
